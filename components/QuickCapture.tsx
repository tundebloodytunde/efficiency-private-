...
export default function QuickCapture() {
  ...
  // Countdown tick while timer is active
  useEffect(() => {
  ...
  return (
    <>
      {/* Floating button — shows countdown if timer running */}
      <button
        onClick={() => setOpen(true)}
        className="fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-br from-violet-600 to-pink-600 rounded-full shadow-2xl shadow-violet-500/40 flex flex-col items-center justify-center hover:scale-110 transition-transform active:scale-95 z-40"
